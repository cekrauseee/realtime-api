...
import { joinTopicListener, leaveTopicListener } from '../listeners'
...
export const TOPIC_EVENTS = ['topic:join', 'topic:leave'] as const

export const TOPIC_EVENTS_DECLARATION: EventsDeclaration<TopicEvent> = {
  'topic:join': { listener: joinTopicListener },
  'topic:leave': { listener: leaveTopicListener }
}
